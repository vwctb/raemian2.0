...
export const getInitialFamilyGroup = createAction(GET_INITIAL_FAMILYGROUP,AuthAPI.getInitalFamilyGroup);
...
const initialState = Map({
    ...
    register: Map({
        ...
        base: Map({
            ...
            uuid: 'uuidkey10120201',
            phonetype: 'android',
            pushid: 'pushidguest10120201',
            profile:Map({
                userkey:0,
                icon:9,
                img:'',
...
export default handleActions({
    ...
    ...pender({
        ...
        onSuccess: (state, action) =>{ 
            ...
            return state.setIn(['register','base','authConfirm'], data);
        }
    }),
    ...pender({
        type: POST_LOGIN,
